<template>
	...
	<a-layout-sider
		...
		:style="{ backgroundColor: 'transparent',}">
			<div class="brand"><img src="images/logo-ct-black.png" alt=""> <span>Project Manage</span></div>
			<hr>
			...
			<a-menu theme="light" mode="inline">
				...
				<a-menu-item>
					<inertia-link :href="$route('admin.user.index')">
						<span class="icon">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<a-menu-item>
					<inertia-link :href="$route('admin.project.index')" >
						<span class="icon">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<a-menu-item>
					<inertia-link :href="$route('admin.task.index')" >
						<span class="icon">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path fill-rule="evenodd" clip-rule="evenodd" d="M3 6C3 4.34315 4.34315 3 6 3H16C16.3788 3 16.725 3.214 16.8944 3.55279C17.0638 3.89157 17.0273 4.29698 16.8 4.6L14.25 8L16.8 11.4C17.0273 11.703 17.0638 12.1084 16.8944 12.4472C16.725 12.786 16.3788 13 16 13H6C5.44772 13 5 13.4477 5 14V17C5 17.5523 4.55228 18 4 18C3.44772 18 3 17.5523 3 17V6Z" fill="#111827"/>
							</svg>
			...
			<a-button v-if="!workingBtnVisible" @click="markAttend('start')" type="primary" block target="_blank">
				Start working
			</a-button>
			<a-button v-else @click="markAttend('end')" type="danger" block target="_blank">
				Stop working
			</a-button>
	...
	export default ({
		...
		data() {
			return {
				...
				workingBtnVisible : (this.$page.props.auth.user.is_working ),
				logged_user_id : (this.$page.props.auth.user.id ),
			}
		},
		methods:{
		markAttend(type) {
				this.$inertia.post(
                route("admin.attend.store"),
                {
					type: type,
				...
				},
                {
					onFinish: () => {
						...
						this.workingBtnVisible = this.$page.props.auth.user.is_working ;
